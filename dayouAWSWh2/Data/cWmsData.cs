...
namespace dayouAWSWh2.Data
{
    internal class cWmsData
    {
        ...
        /// <returns></returns>
        //입출고 현황
        public cWmsOutItemList getWmsOutSP3()
        {
            cWmsOutItemList _list = new cWmsOutItemList();
            ...
            try
            {
                using (SqlConnection connect = new SqlConnection(_conn))
                {
                    SqlCommand cmd = new SqlCommand("SP_CS_WMS_OUT_GET_WH2", connect);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public cWmsInItemList getWmsInSP3()
        {
            cWmsInItemList _list = new cWmsInItemList();
            ...
            try
            {
                using (SqlConnection connect = new SqlConnection(_conn))
                {
                    SqlCommand cmd = new SqlCommand("SP_CS_WMS_IN_GET_WH2", connect);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public cWmsInResultItemList getWmsInResultSP3(string start_date, string stop_date, string car_code, string fr_gubun, string alc_code)
        {
            cWmsInResultItemList _list = new cWmsInResultItemList();
        ...
        public cWmsOutResultItemList getWmsOutResultSP3(string start_date, string stop_date, string car_code, string fr_gubun, string alc_code)
        {
            cWmsOutResultItemList _list = new cWmsOutResultItemList();
        ...
        //입고 강제완료
        public cMessage WmsInForceSP3(string id_type, string id_date, string id_time, string id_index, string id_subidx)
        {
            cMessage _items = new cMessage();
            ...
            try
            {
                using (SqlConnection connect = new SqlConnection(_conn))
                {
                    SqlCommand cmd = new SqlCommand("SP_WMS_IN_ORDER_FORCE_WH2", connect);
                    cmd.Parameters.Add(new SqlParameter("ID_TYPE", id_type));
                    cmd.Parameters.Add(new SqlParameter("ID_DATE", id_date));
                    cmd.Parameters.Add(new SqlParameter("ID_TIME", id_time));
                    cmd.Parameters.Add(new SqlParameter("ID_INDEX", id_index));
        ...
        //입고 취소
        public cMessage WmsInCancelSP3(string id_type, string id_date, string id_time, string id_index, string id_subidx)
        {
            cMessage _items = new cMessage();
            ...
            try
            {
                using (SqlConnection connect = new SqlConnection(_conn))
                {
                    SqlCommand cmd = new SqlCommand("SP_WMS_IN_ORDER_CANCEL_WH2", connect);
                    cmd.Parameters.Add(new SqlParameter("ID_TYPE", id_type));
                    cmd.Parameters.Add(new SqlParameter("ID_DATE", id_date));
                    cmd.Parameters.Add(new SqlParameter("ID_TIME", id_time));
                    cmd.Parameters.Add(new SqlParameter("ID_INDEX", id_index));
        ...
        //출고 강제완료
        public cMessage WmsOutForceSP3(string id_type, string id_date, string id_time, string id_index, string id_subidx)
        {
            cMessage _items = new cMessage();
            ...
            try
            {
                using (SqlConnection connect = new SqlConnection(_conn))
                {
                    SqlCommand cmd = new SqlCommand("SP_WMS_OUT_ORDER_FORCE_WH2", connect);
                    cmd.Parameters.Add(new SqlParameter("ID_TYPE", id_type));
                    cmd.Parameters.Add(new SqlParameter("ID_DATE", id_date));
                    cmd.Parameters.Add(new SqlParameter("ID_TIME", id_time));
                    cmd.Parameters.Add(new SqlParameter("ID_INDEX", id_index));
        ...
        //출고 취소
        public cMessage WmsOutCancelSP3(string id_type, string id_date, string id_time, string id_index, string id_subidx)
        {
            cMessage _items = new cMessage();
            ...
            try
            {
                using (SqlConnection connect = new SqlConnection(_conn))
                {
                    SqlCommand cmd = new SqlCommand("SP_WMS_OUT_ORDER_CANCEL_WH2", connect);
                    cmd.Parameters.Add(new SqlParameter("ID_TYPE", id_type));
                    cmd.Parameters.Add(new SqlParameter("ID_DATE", id_date));
                    cmd.Parameters.Add(new SqlParameter("ID_TIME", id_time));
                    cmd.Parameters.Add(new SqlParameter("ID_INDEX", id_index));
